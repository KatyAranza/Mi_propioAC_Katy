...
md"
¿Qué observas en la esquina inferior izquierda de `ImageView` cuando ejecutas la celda anterior y colocas el cursor sobre la imagen? Hay números, como coordenadas como si la imagen estuviera en un plano cartesiano, también hay números que significan un color porque dice RGB

¿Qué sucede si mueves el cursor de lugar? El número de la esquina cambia en cada puntito de la imágen.

¿Qué cosas cambian cuando repetimos el mismo ejercicio con otras imágenes de la lista? En todas las imágenes hay coordenadas x,y. y coordenadas de color, pero si la imagen está en blanco y negro sólo hay tinalidades de gris. 
...
# ╔═╡ 8c91d955-3570-43e7-bbf8-35fc1475e38d
#columnas = 210-323
# renglones= 190-290
...
# ╔═╡ 1ca7415c-736b-4414-8c2a-d4c3bc33a680
#fondo rosa RGB(1.0, 0.8, 1.0)    rojo RGB(0.8, 0.05, 0.0)    café RGB(0.7, 0.6, 0.0)    carnita RGB(1.2, 0.9, 0.8)  
#     negro RGB(0.0, 0.0, 0.0)    azul RGB(0.0, 0.0, 0.75)    amarillo RGB(1.0, 1.0, 0.6)

arte_de_pixeles = [
	RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0) RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  

	RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.8, 0.05, 0.0)  RGB(0.8, 0.05, 0.0)  RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)   RGB(1.0, 0.8, 1.0)      RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)       

    RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.8, 0.05, 0.0)  RGB(0.8, 0.05, 0.0)  RGB(0.8, 0.05, 0.0)        RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0)  RGB(0.8, 0.05, 0.0)  RGB(0.8, 0.05, 0.0)        RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)	

	RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(0.0, 0.0, 0.0)  RGB(1.2, 0.9, 0.8)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  

	RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.7, 0.6, 0.0)  RGB(1.2, 0.9, 0.8)  RGB(0.7, 0.6, 0.0)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(0.0, 0.0, 0.0)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)
	
	RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.7, 0.6, 0.0)  RGB(1.2, 0.9, 0.8)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(0.7, 0.6, 0.0)   RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)

	RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0) RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)

	RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)

	RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(0.0, 0.0, 0.75) RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)

	RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(0.0, 0.0, 0.75)  RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(0.0, 0.0, 0.75) RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)

	RGB(1.0, 0.8, 1.0)  RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0)  RGB(0.0, 0.0, 0.75)  RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0)  RGB(0.8, 0.05, 0.0) RGB(0.8, 0.05, 0.0) RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)

	RGB(1.0, 0.8, 1.0)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(0.8, 0.05, 0.0) RGB(0.0, 0.0, 0.75)  RGB(1.0, 1.0, 0.6) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(1.0, 1.0, 0.6)  RGB(0.0, 0.0, 0.75) RGB(0.8, 0.05, 0.0)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)

	RGB(1.0, 0.8, 1.0)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)

	RGB(1.0, 0.8, 1.0)  RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(1.2, 0.9, 0.8)  RGB(1.2, 0.9, 0.8)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)

    RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75)          RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(0.0, 0.0, 0.75) RGB(1.0, 0.8, 1.0)           RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  

	RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)

	RGB(1.0, 0.8, 1.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)   RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(1.0, 0.8, 1.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(0.7, 0.6, 0.0)  RGB(1.0, 0.8, 1.0)
                                                            ]			
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "caebcdd8076c37212c618482e7e94b8716fb2c3f"
